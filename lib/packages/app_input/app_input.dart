...
class AppInput extends StatefulWidget {
  ...
  /// Use this only for vertical padding
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (widget.isDropDown)
                                  ...
                                  // this text is what it shows when it is active
  ...
  TextFormField textField(Color textColor, Color hintColor) {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          // it only shows when the textField is active
          suffixIcon: widget.isPasswordField ? _passwordVisibility() : null),
      autovalidateMode: widget.autovalidateMode,
      controller: controller,
      validator: widget.validator == null
          ? null
